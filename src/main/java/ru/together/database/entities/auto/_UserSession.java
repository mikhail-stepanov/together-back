...
/**
 * Class _UserSession was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _UserSession extends CayenneDataObject {
    ...
    public static final Property<User> SESSION_TO_USER = Property.create("sessionToUser", User.class);
    ...
    public void setSessionToUser(User sessionToUser) {
        setToOneTarget("sessionToUser", sessionToUser, true);
    }

    public User getSessionToUser() {
        return (User)readProperty("sessionToUser");
    }
